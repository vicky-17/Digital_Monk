package com.digitalmonk.app.service
...
import com.digitalmonk.app.service.monitor.*
...
class WatchdogService : Service() {
    ...
    override fun onCreate() {
        ...
        settingsPageReader = SettingsPageReader(com.digitalmonk.app.data.local.prefs.PrefsManager(this))
            ...
            ProtectionIssue.ACCESSIBILITY_DISABLED -> {
                if (settings.isBankingBypassEnabled) {
                    Handler(Looper.getMainLooper()).post {
                        Toast.makeText(this, "Blocked during Banking Mode. Enable Accessibility.", Toast.LENGTH_LONG).show()
                    }
    ...
    private fun buildNotification(): Notification {
        return com.digitalmonk.app.service.notification.NotificationHelper.buildGuardianForegroundNotification(this)
    }
