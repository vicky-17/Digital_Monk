...
import com.curbme.app.service.accessibility.GuardianAccessibilityService.Companion.currentRootNode
import com.curbme.app.ui.block.BlockedPageActivity.Companion.settingsBlock
...
//            Log.d("MONK_TRACE", "isDangerousSettingsPage() → GATE3 FAIL: no dangerous title found");
        ...
        if (!hasExactText(root, "CurbMe")) {
//            Log.d("MONK_TRACE", "isDangerousSettingsPage() → GATE4 FAIL: 'CurbMe' text not found");
            return false
        }
